...
public class Main {
    public static void main(String[] args) throws IOException {
        ...
        MapOfEncode mapOfEncode = huffManTest.encode()
        ...
        IOTools.writeCode("E:\\javaprogrames\\CodeAndDecodeByHuffman\\Code.txt",mapOfEncode.getEncodeString());
        IOTools.writeMap("E:\\javaprogrames\\CodeAndDecodeByHuffman\\Map.txt",mapOfEncode.getEncodeMap());
